...
function ModuleLoader.loadModules()
    ...
    modules.fWBuilder = io.requirefile("NOCT-xt/frames/FunctionWatcher.lua")
    ...
    modules.fWModule = io.requirefile("NOCT-xt/modules/FunctionWatcher.lua")
    ...
    modules.functionObject = io.requirefile("NOCT-xt/objects/Function.lua")
end
